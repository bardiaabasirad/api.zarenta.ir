...
class UpdateProductSettingsRequest extends FormRequest
{
    ...
    {
        return [
            'today_spot_settlement_buy_fee_margin' => ['sometimes','integer'],
            'today_spot_settlement_sell_fee_margin' => ['sometimes','integer'],
            ...
            'tomorrow_spot_settlement_buy_fee_margin' => ['sometimes','integer'],
            'tomorrow_spot_settlement_sell_fee_margin' => ['sometimes','integer'],
            ...
            'day_after_tomorrow_spot_settlement_buy_fee_margin' => ['sometimes','integer'],
            'day_after_tomorrow_spot_settlement_sell_fee_margin' => ['sometimes','integer'],
            ...
            'gold_coin_86_buy_fee_margin' => ['sometimes','integer'],
            'gold_coin_86_sell_fee_margin' => ['sometimes','integer'],
            ...
            'gold_half_coin_86_buy_fee_margin' => ['sometimes','integer'],
            'gold_half_coin_86_sell_fee_margin' => ['sometimes','integer'],
            ...
            'gold_quarter_coin_86_buy_fee_margin' => ['sometimes','integer'],
            'gold_quarter_coin_86_sell_fee_margin' => ['sometimes','integer'],
            ...
            'gold_coin_old_version_buy_fee_margin' => ['sometimes','integer'],
            'gold_coin_old_version_sell_fee_margin' => ['sometimes','integer'],
