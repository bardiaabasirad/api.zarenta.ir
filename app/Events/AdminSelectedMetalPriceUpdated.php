...
class AdminSelectedMetalPriceUpdated implements ShouldBroadcastNow
{
     ...
     */
    public function __construct(public SelectedMetalPrice $selectedMetalPrice) {}
    ...
    {
        return new Channel('admin-selected-metal-prices');
    }
